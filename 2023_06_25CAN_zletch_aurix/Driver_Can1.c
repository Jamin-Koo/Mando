...
static void Driver_Can_EnrollObject(int32_t msgObjId,  uint32_t msgId, uint8_t frameType, uint8_t msgDlc, uint32_t extendedFrame, IfxMultican_Can_MsgObj* pArrObjNum)
{
    ...
    canMsgObjConfig.msgObjId              = msgObjId;                                                      // Extended ID �뜝�룞�삕�뜝�룞�삕
    canMsgObjConfig.messageId             = msgId;
    canMsgObjConfig.frame                 = frameType;
    canMsgObjConfig.control.messageLen    = msgDlc;
    canMsgObjConfig.control.extendedFrame = extendedFrame;                                                 // Extended ID �뜝�룞�삕�뜝占�
...
void Driver_Can_Init(void)
{
    ...
    canNodeConfig.baudrate = 500000UL;                                                                      // CAN �뜝�뙂�벝�삕 �뜝�룞�삕�뜝�룞�삕 500kbps
    canNodeConfig.nodeId    = (IfxMultican_NodeId)((int)IfxMultican_NodeId_0);   // CAN�뜝�룞�삕 Node ID �뜝�룞�삕�뜝�룞�삕 0�뜝�룞�삕�뜝�룞�삕�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕�뜝�룞�삕
    canNodeConfig.rxPin     = &IfxMultican_RXD0B_P20_7_IN;                                              // �뜝�뙃琉꾩삕�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕
    canNodeConfig.rxPinMode = IfxPort_InputMode_pullUp;
    canNodeConfig.txPin     = &IfxMultican_TXD0_P20_8_OUT;                                              // �뜝�룞�삕�뜝�룞�삕�뜝占� �뜝�룞�삕�뜝�룞�삕
    canNodeConfig.txPinMode = IfxPort_OutputMode_pushPull;

    IfxMultican_Can_Node_init(&stEcu1Can.CanECU1Node, &canNodeConfig);                     // CAN node �뜝�떗源띿삕�솕
...
void canIsrRxHandler(void)
{
   ...
   //  IfxPort_setPinLow(LED2);
    ...
    //blinkLED2();
    //readStatus = IfxMultican_Can_MsgObj_readMessage(&stEcu1Can.CanECU1MsgRxObj[0], &stEcu1Can.rxMsg);  // �뜝�룞�삕�뜝�룞�삕�뜝�룞�삕�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕

    readStatus = IfxMultican_Can_MsgObj_readMessage(&stEcu1Can.CanECU1MsgRxObj[0], &RX_Msg);  // �뜝�룞�삕�뜝�룞�삕�뜝�룞�삕�뜝�룞�삕�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕�뜝�뙏�눦�삕 �뜝�룞�삕�뜝�룞�삕�뜝�룞�삕�뜝�떬怨ㅼ삕
...
//      u32nuTemp1 = stEcu1Can.rxMsg.data[0];  // LSB 4byte
 //     u32nuTemp2 = stEcu1Can.rxMsg.data[1];  // MSB 4byte
        CAN_rx_data_MSB.RX_Data32 = RX_Msg.data[0];   //union�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕轢ュ뜝占� 4 byte�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕
