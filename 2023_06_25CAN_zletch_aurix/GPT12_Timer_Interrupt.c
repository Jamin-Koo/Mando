...
{
    /* GPT12 �뜝�룞�삕�뜝占� �뜝�떗源띿삕�솕 */
    IfxGpt12_enableModule(&MODULE_GPT120); /* GPT12 �뜝�룞�삕�뜝占� �솢�뜝�룞�삕�솕 */
    IfxGpt12_setGpt1BlockPrescaler(&MODULE_GPT120, IfxGpt12_Gpt1BlockPrescaler_16);

    /* Timer T2 �뜝�떗源띿삕�솕 */
    IfxGpt12_T2_setMode(&MODULE_GPT120, IfxGpt12_Mode_timer);                           /* T2�뜝�룞�삕 Timer �뜝�룞�삕�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕    */
    IfxGpt12_T2_setTimerValue(&MODULE_GPT120, RELOAD_VALUE_200ms);                      /* T2 �뜝�룞�삕�뜝�떥�벝�삕 �뜝�룞�삕�뜝�룞�삕 200�뜝�룞�삕�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕 */

    volatile Ifx_SRC_SRCR *src_t2 = IfxGpt12_T2_getSrc(&MODULE_GPT120);                 /* �뜝�룞�삕�뜝�떢琉꾩삕�듃 �뜝�뙇�눦�삕 �뜝�룞�삕�뜝�룞�삕�뜝�룞�삕�뜝�룞�삕       */
    IfxSrc_init(src_t2, ISR_PROVIDER_GPT12_TIMER, ISR_PRIORITY_GPT12_TIMER_T2);         /* �뜝�떗源띿삕�솕        */
    IfxSrc_enable(src_t2);                                                              /* GPT12 �뜝�룞�삕�뜝�떢琉꾩삕�듃 �솢�뜝�룞�삕�솕      */

    IfxGpt12_T2_run(&MODULE_GPT120, IfxGpt12_TimerRun_start);                           /* ���뜝�떛紐뚯삕 �뜝�룞�삕�뜝�룞�삕               */
}
