...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define ISR_PRIORITY_TOM1    4                       /* Interrupt priority number                                    */
#define ISR_PRIORITY_TOM2    2                       /* Interrupt priority number                                    */

#define TOM_FREQ            800.0f                    /* TOM frequency                                                */
#define TOM_FREQ2           800.0f                    /* TOM frequency                                                */
...
void initGtmTom2(void)
{
    ...
    timerConfig2.tom                  = IfxGtm_Tom_0;                            /* Define the timer used            */
    timerConfig2.timerChannel         = IfxGtm_Tom_Ch_0;                         /* Define the channel used          */
