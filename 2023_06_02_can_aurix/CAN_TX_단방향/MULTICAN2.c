...
void initMultican1(void)
{
    ...
    g_multican1.canNodeConfig.nodeId = (IfxMultican_NodeId)((int)IfxMultican_NodeId_0);                         // CAN의 TX Node ID 설정 0번으로 설정함
    g_multican1.canNodeConfig.rxPin     = &IfxMultican_RXD0B_P20_7_IN;                                          // RX핀 설정
    g_multican1.canNodeConfig.rxPinMode = IfxPort_InputMode_pullUp;
    g_multican1.canNodeConfig.txPin     = &IfxMultican_TXD0_P20_8_OUT;                                          // TX핀 설정

    IfxMultican_Can_Node_init(&g_multican1.canSrcNode, &g_multican1.canNodeConfig);                              // TX configuration 설정
    ...
    g_multican1.canNodeConfig.baudrate = 500000UL;                                                              // CAN 속도 설정 500kbps
    g_multican1.canNodeConfig.nodeId    = (IfxMultican_NodeId)((int)IfxMultican_NodeId_0);                      // CAN의 RX Node ID 설정 0번으로 설정함
    g_multican1.canNodeConfig.rxPin     = &IfxMultican_RXD0B_P20_7_IN;                                          // RX핀 설정
    g_multican1.canNodeConfig.rxPinMode = IfxPort_InputMode_pullUp;
    g_multican1.canNodeConfig.txPin     = &IfxMultican_TXD0_P20_8_OUT;                                          // TX핀 설정


    IfxMultican_Can_Node_init(&g_multican1.canDstNode, &g_multican1.canNodeConfig);                              // RX configuration 설정
...
void initMultican2(void)
{
    ...
    g_multican2.canNodeConfig.nodeId = (IfxMultican_NodeId)((int)IfxMultican_NodeId_1);                         // CAN의 TX Node ID 설정 0번으로 설정함
    g_multican2.canNodeConfig.rxPin     = &IfxMultican_RXD0B_P20_7_IN;                                          // RX핀 설정
    g_multican2.canNodeConfig.rxPinMode = IfxPort_InputMode_pullUp;
    g_multican2.canNodeConfig.txPin     = &IfxMultican_TXD0_P20_8_OUT;                                          // TX핀 설정

    IfxMultican_Can_Node_init(&g_multican2.canSrcNode, &g_multican2.canNodeConfig);                              // TX configuration 설정
    ...
    g_multican2.canNodeConfig.baudrate = 500000UL;                                                              // CAN 속도 설정 500kbps
    g_multican2.canNodeConfig.nodeId    = (IfxMultican_NodeId)((int)IfxMultican_NodeId_1);                      // CAN의 RX Node ID 설정 0번으로 설정함
    g_multican2.canNodeConfig.rxPin     = &IfxMultican_RXD0B_P20_7_IN;                                          // RX핀 설정
    g_multican2.canNodeConfig.rxPinMode = IfxPort_InputMode_pullUp;
    g_multican2.canNodeConfig.txPin     = &IfxMultican_TXD0_P20_8_OUT;                                          // TX핀 설정


    IfxMultican_Can_Node_init(&g_multican2.canDstNode, &g_multican2.canNodeConfig);                              // RX configuration 설정
    ...
    //g_multican2.canMsgObjConfig.txInterrupt.srcId = TX_INTERRUPT_SRC_ID;
...
void transmitCanMessage(void)
{
    ...
    IfxMultican_Message_init(&g_multican1.rxMsg,
                             INVALID_ID_VALUE,
                             INVALID_DATA_VALUE,
                             INVALID_DATA_VALUE,
                             g_multican1.canMsgObjConfig.control.messageLen);

    /* Initialization of the TX message */
    IfxMultican_Message_init(&g_multican1.txMsg,
                             g_multican1.canMsgObjConfig.messageId,
                             dataLow,
                             dataHigh,
                             g_multican1.canMsgObjConfig.control.messageLen);
    ...
    while( IfxMultican_Status_notSentBusy ==
           IfxMultican_Can_MsgObj_sendMessage(&g_multican1.canSrcMsgObj, &g_multican1.txMsg) )
    {
    }
